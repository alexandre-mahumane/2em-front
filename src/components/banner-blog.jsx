...
export const Banner = ({ title, category, photo, author, data }) => {
  return (
    <div className="relative min-h-screen">
      <div className="bg-main-blue-100 flex items-center justify-center text-white absolute inset-0 z-10 ">
        <motion.div
        ...
        >
          <h4 className="text-base font-bold border border-white rounded-full py-2 px-4 sm:text-lg lg:text-xl text-center mt-4">
            {category}
          </h4>
          <h3 className="font-extrabold text-2xl sm:text-3xl lg:text-4xl text-center mt-2">
            {title}
          </h3>
